          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Education</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Master of Computer Applications (MCA) from Guru Gobind
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Over 10 years of experience in software development and
                      project management
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Skills</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Proficient in Java, JavaScript, React, Node.js, MongoDB,
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Certifications</span>
                  </Fragment>
                )}
              </h2>
